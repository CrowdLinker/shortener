...
Route::group(['prefix' => 'api'],function()
{
    ...
    Route::get('/links/detail/{shortlink}',['as' => 'api.url.detail','before' => 'auth|checkuser','uses' => 'AnalyticsController@detail']);
    Route::get('/links/map/{shortlink}',['as' => 'api.url.map','before' => 'auth','uses|checkuser' => 'AnalyticsController@map']);
